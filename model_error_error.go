...
func NewErrorError(errorName string, errorMsg string) *ErrorError {
	this := ErrorError{}
...
func (o *ErrorError) GetErrorName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ErrorError) GetErrorNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorError) SetErrorName(v string) {
	o.ErrorName = v
}

// GetErrorMsg returns the ErrorMsg field value
func (o *ErrorError) GetErrorMsg() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ErrorError) GetErrorMsgOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ErrorError) SetErrorMsg(v string) {
	o.ErrorMsg = v
}

...
// checks if the RequestListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestListResponse{}

// RequestListResponse struct for RequestListResponse
type RequestListResponse struct {
	Requests []DocumentRequestSummary `json:"requests,omitempty"`
...
func (o *RequestListResponse) GetRequests() []DocumentRequestSummary {
	if o == nil || IsNil(o.Requests) {
		var ret []DocumentRequestSummary
		return ret
	}
	return o.Requests
}
...
// SetRequests gets a reference to the given []DocumentRequestSummary and assigns it to the Requests field.
...
// SetListInfo gets a reference to the given ListInfo and assigns it to the ListInfo field.
func (o *RequestListResponse) SetListInfo(v ListInfo) {
	o.ListInfo = &v
}

func (o RequestListResponse) MarshalJSON() ([]byte, error) {
...
func (o RequestListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableRequestListResponse struct {
	value *RequestListResponse
	isSet bool
}

func (v NullableRequestListResponse) Get() *RequestListResponse {
	return v.value
}

func (v *NullableRequestListResponse) Set(val *RequestListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestListResponse(val *RequestListResponse) *NullableRequestListResponse {
	return &NullableRequestListResponse{value: val, isSet: true}
}

func (v NullableRequestListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

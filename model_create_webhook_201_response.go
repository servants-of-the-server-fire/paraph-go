...
type CreateWebhook201Response struct {
	Webhook *CreateWebhook201ResponseWebhook `json:"webhook,omitempty"`
}
...
func (o *CreateWebhook201Response) GetWebhook() CreateWebhook201ResponseWebhook {
	if o == nil || IsNil(o.Webhook) {
		var ret CreateWebhook201ResponseWebhook
		return ret
	}
	return *o.Webhook
}
...
func (o *CreateWebhook201Response) GetWebhookOk() (*CreateWebhook201ResponseWebhook, bool) {
	if o == nil || IsNil(o.Webhook) {
		return nil, false
	}
...
func (o *CreateWebhook201Response) HasWebhook() bool {
	if o != nil && !IsNil(o.Webhook) {
		return true
	}
...
// SetWebhook gets a reference to the given CreateWebhook201ResponseWebhook and assigns it to the Webhook field.
func (o *CreateWebhook201Response) SetWebhook(v CreateWebhook201ResponseWebhook) {
	o.Webhook = &v
}

...
type UpdateTemplateRequest struct {
	...
	SignaturePlacements []SignaturePlacementInput `json:"signature_placements,omitempty"`
}
...
// GetSignaturePlacements returns the SignaturePlacements field value if set, zero value otherwise.
func (o *UpdateTemplateRequest) GetSignaturePlacements() []SignaturePlacementInput {
	if o == nil || IsNil(o.SignaturePlacements) {
		var ret []SignaturePlacementInput
		return ret
	}
	return o.SignaturePlacements
}

// GetSignaturePlacementsOk returns a tuple with the SignaturePlacements field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *UpdateTemplateRequest) GetSignaturePlacementsOk() ([]SignaturePlacementInput, bool) {
	if o == nil || IsNil(o.SignaturePlacements) {
		return nil, false
	}
	return o.SignaturePlacements, true
}
...
// SetSignaturePlacements gets a reference to the given []SignaturePlacementInput and assigns it to the SignaturePlacements field.
func (o *UpdateTemplateRequest) SetSignaturePlacements(v []SignaturePlacementInput) {
	o.SignaturePlacements = v
}
...
func (o UpdateTemplateRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SignaturePlacements) {
		toSerialize["signature_placements"] = o.SignaturePlacements
	}

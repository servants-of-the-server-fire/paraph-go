...
func NewTemplateDetail(id string, name string, createdAt time.Time, updatedAt time.Time, fields []Field, signaturePlacements []SignaturePlacement) *TemplateDetail {
	...
	this.Fields = fields
	this.SignaturePlacements = signaturePlacements
	return &this
}
...
// GetSignaturePlacements returns the SignaturePlacements field value
func (o *TemplateDetail) GetSignaturePlacements() []SignaturePlacement {
	if o == nil {
		var ret []SignaturePlacement
		return ret
	}
...
// GetSignaturePlacementsOk returns a tuple with the SignaturePlacements field value
// and a boolean to check if the value has been set.
...
// SetSignaturePlacements sets field value

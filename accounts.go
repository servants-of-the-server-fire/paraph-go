...
func newAccounts(rootSDK *Paraph, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Accounts {
	return &Accounts{
		rootSDK:          rootSDK,
...
func (s *Accounts) Get(ctx context.Context, opts ...operations.Option) (*operations.GetAccountResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out operations.GetAccountResponseBody

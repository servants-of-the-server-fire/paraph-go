...
// checks if the ListInfo type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListInfo{}

// ListInfo struct for ListInfo
type ListInfo struct {
	Page int32 `json:"page"`
	NumPages int32 `json:"num_pages"`
	NumResults int32 `json:"num_results"`
	PageSize int32 `json:"page_size"`
}

type _ListInfo ListInfo

// NewListInfo instantiates a new ListInfo object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListInfo(page int32, numPages int32, numResults int32, pageSize int32) *ListInfo {
	this := ListInfo{}
	this.Page = page
...
// NewListInfoWithDefaults instantiates a new ListInfo object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListInfoWithDefaults() *ListInfo {
	this := ListInfo{}
	return &this
}

// GetPage returns the Page field value
func (o *ListInfo) GetPage() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *ListInfo) GetPageOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Page, true
...
func (o *ListInfo) SetPage(v int32) {
	o.Page = v
}

// GetNumPages returns the NumPages field value
func (o *ListInfo) GetNumPages() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// GetNumPagesOk returns a tuple with the NumPages field value
// and a boolean to check if the value has been set.
func (o *ListInfo) GetNumPagesOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// SetNumPages sets field value
func (o *ListInfo) SetNumPages(v int32) {
	o.NumPages = v
}

// GetNumResults returns the NumResults field value
func (o *ListInfo) GetNumResults() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// GetNumResultsOk returns a tuple with the NumResults field value
// and a boolean to check if the value has been set.
func (o *ListInfo) GetNumResultsOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.NumResults, true
}

// SetNumResults sets field value
func (o *ListInfo) SetNumResults(v int32) {
	o.NumResults = v
}

// GetPageSize returns the PageSize field value
func (o *ListInfo) GetPageSize() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListInfo) GetPageSizeOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ListInfo) SetPageSize(v int32) {
	o.PageSize = v
}

func (o ListInfo) MarshalJSON() ([]byte, error) {
...
func (o ListInfo) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["page"] = o.Page
	toSerialize["num_pages"] = o.NumPages
	toSerialize["num_results"] = o.NumResults
	toSerialize["page_size"] = o.PageSize
	return toSerialize, nil
}

func (o *ListInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varListInfo := _ListInfo{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListInfo)

	if err != nil {
		return err
	}

	*o = ListInfo(varListInfo)

	return err
}

type NullableListInfo struct {
	value *ListInfo
	isSet bool
}

func (v NullableListInfo) Get() *ListInfo {
	return v.value
}

func (v *NullableListInfo) Set(val *ListInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableListInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableListInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListInfo(val *ListInfo) *NullableListInfo {
	return &NullableListInfo{value: val, isSet: true}
}

func (v NullableListInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true

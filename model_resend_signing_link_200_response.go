...
// checks if the ResendSigningLink200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ResendSigningLink200Response{}

// ResendSigningLink200Response struct for ResendSigningLink200Response
type ResendSigningLink200Response struct {
	Signer *Signer `json:"signer,omitempty"`
}

// NewResendSigningLink200Response instantiates a new ResendSigningLink200Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewResendSigningLink200Response() *ResendSigningLink200Response {
	this := ResendSigningLink200Response{}
	return &this
}

// NewResendSigningLink200ResponseWithDefaults instantiates a new ResendSigningLink200Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewResendSigningLink200ResponseWithDefaults() *ResendSigningLink200Response {
	this := ResendSigningLink200Response{}
	return &this
}

// GetSigner returns the Signer field value if set, zero value otherwise.
func (o *ResendSigningLink200Response) GetSigner() Signer {
...
func (o *ResendSigningLink200Response) GetSignerOk() (*Signer, bool) {
	if o == nil || IsNil(o.Signer) {
		return nil, false
	}
...
func (o *ResendSigningLink200Response) HasSigner() bool {
	if o != nil && !IsNil(o.Signer) {
		return true
	}
...
func (o *ResendSigningLink200Response) SetSigner(v Signer) {
	o.Signer = &v
}

func (o ResendSigningLink200Response) MarshalJSON() ([]byte, error) {
...
func (o ResendSigningLink200Response) ToMap() (map[string]interface{}, error) {
...
type NullableResendSigningLink200Response struct {
	value *ResendSigningLink200Response
	isSet bool
}

func (v NullableResendSigningLink200Response) Get() *ResendSigningLink200Response {
	return v.value
}

func (v *NullableResendSigningLink200Response) Set(val *ResendSigningLink200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableResendSigningLink200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableResendSigningLink200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResendSigningLink200Response(val *ResendSigningLink200Response) *NullableResendSigningLink200Response {
	return &NullableResendSigningLink200Response{value: val, isSet: true}
}

func (v NullableResendSigningLink200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResendSigningLink200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

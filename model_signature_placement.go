...
// checks if the SignaturePlacement type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SignaturePlacement{}

// SignaturePlacement struct for SignaturePlacement
...
type _SignaturePlacement SignaturePlacement
...
func (o SignaturePlacement) MarshalJSON() ([]byte, error) {
...
func (o SignaturePlacement) ToMap() (map[string]interface{}, error) {
...
func (o *SignaturePlacement) UnmarshalJSON(data []byte) (err error) {
	...
	varSignaturePlacement := _SignaturePlacement{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSignaturePlacement)

	if err != nil {
		return err
	}

	*o = SignaturePlacement(varSignaturePlacement)

	return err
}

type NullableSignaturePlacement struct {
	value *SignaturePlacement
	isSet bool
}

func (v NullableSignaturePlacement) Get() *SignaturePlacement {
	return v.value
}

func (v *NullableSignaturePlacement) Set(val *SignaturePlacement) {
	v.value = val
	v.isSet = true
}

func (v NullableSignaturePlacement) IsSet() bool {
	return v.isSet
}

func (v *NullableSignaturePlacement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSignaturePlacement(val *SignaturePlacement) *NullableSignaturePlacement {
	return &NullableSignaturePlacement{value: val, isSet: true}
}

func (v NullableSignaturePlacement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSignaturePlacement) UnmarshalJSON(src []byte) error {
	v.isSet = true

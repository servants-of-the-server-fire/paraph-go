...
// checks if the Register201ResponseAuth type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Register201ResponseAuth{}

// Register201ResponseAuth struct for Register201ResponseAuth
type Register201ResponseAuth struct {
	Message string `json:"message"`
}

type _Register201ResponseAuth Register201ResponseAuth
...
func (o Register201ResponseAuth) MarshalJSON() ([]byte, error) {
...
func (o Register201ResponseAuth) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["message"] = o.Message
	return toSerialize, nil
}

func (o *Register201ResponseAuth) UnmarshalJSON(data []byte) (err error) {
	...
	varRegister201ResponseAuth := _Register201ResponseAuth{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegister201ResponseAuth)

	if err != nil {
		return err
	}

	*o = Register201ResponseAuth(varRegister201ResponseAuth)

	return err
}

type NullableRegister201ResponseAuth struct {
	value *Register201ResponseAuth
	isSet bool
}

func (v NullableRegister201ResponseAuth) Get() *Register201ResponseAuth {
	return v.value
}

func (v *NullableRegister201ResponseAuth) Set(val *Register201ResponseAuth) {
	v.value = val
	v.isSet = true
}

func (v NullableRegister201ResponseAuth) IsSet() bool {
	return v.isSet
}

func (v *NullableRegister201ResponseAuth) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRegister201ResponseAuth(val *Register201ResponseAuth) *NullableRegister201ResponseAuth {
	return &NullableRegister201ResponseAuth{value: val, isSet: true}
}

func (v NullableRegister201ResponseAuth) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRegister201ResponseAuth) UnmarshalJSON(src []byte) error {
	v.isSet = true
